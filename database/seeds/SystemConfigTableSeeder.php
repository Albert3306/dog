...
class SystemConfigTableSeeder extends Seeder
{
    ...
    {
        $configs = [
            ['name' => 'website_title', 'value' => 'DOG'],
            ['name' => 'website_keywords', 'value' => 'DOG,Albert,Albert3306'],
            ['name' => 'company_full_name', 'value' => 'DOG 内容管理系统'],
            ['name' => 'company_short_name', 'value' => 'DOG-CMS'],
            ...
            ['name' => 'system_author_website', 'value' => 'https://github.com/Albert3306/dog']
        ];
